...
Dimension of our cleaned dataset:
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
•	There were some outliers in the continuous predictors, we just did a quick test on one of the continuous variables(cn). But we decided to keep them as they are since there are only a few, and we will filter out the dataset later on with the correlation matrix.
