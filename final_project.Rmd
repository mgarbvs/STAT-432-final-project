...
xgb_model_pr <- xgboost(data = as.matrix(train_data),label = response_data_n_train$PR.Status, max_depth = 4,eta = 1, nthread = 2, nrounds = 10,objective = "binary:logistic", eval_metric = 'auc')
#Can use parallel computing for this task!
...
xgb_model_er <- xgboost(data = as.matrix(train_data),label = response_data_n_train$ER.Status, max_depth = 4,eta = 1, nthread = 2, nrounds = 10,objective = "binary:logistic", eval_metric = 'auc')
...
xgb_model_hrfs <- xgboost(data = as.matrix(train_data),label = response_data_n_train$HER2.Final.Status, max_depth = 4,eta = 1, nthread = 2, nrounds = 10,objective = "binary:logistic", eval_metric = 'auc')
...
xgb_model_ht <- xgboost(data = as.matrix(train_data),label = response_data_n_train$histological.type, max_depth = 4,eta = 1, nthread = 2, nrounds = 10,objective = "binary:logistic", eval_metric = 'auc')
