...
performance(pr_pred_test, measure = "auc")@y.values[[1]]
...
er_pred_test <- prediction(pr_pred, response_data_n_test$ER.Status)
performance(er_pred_test, measure = "auc")@y.values[[1]]
...
performance(hr_pred_test, measure = "auc")@y.values[[1]]
...
performance(ht_pred_test, measure = "auc")@y.values[[1]]
