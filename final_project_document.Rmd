...
svm_12_pred <-br(mldr_12,base.algorith="SVM", seed=432, kernel = "linear", cost = 0.6)
svm_13_pred <-br(mldr_13,base.algorith="SVM", seed=432, kernel = "linear", cost = 0.6)
svm_23_pred <-br(mldr_23,base.algorith="SVM", seed=432, kernel = "linear", cost = 0.6)
...
#XGB 
xgb_12_pred  <-br(mldr_12,base.algorith="XGB", seed=432, cores = 1, eta = 0.3575, nrounds = 150, eval_metric = "auc",subsample = 1)
xgb_13_pred  <-br(mldr_13,base.algorith="XGB", seed=432, cores = 1, eta = 0.3575, nrounds = 150, eval_metric = "auc")
xgb_23_pred  <-br(mldr_23,base.algorith="XGB", seed=432, cores = 1, eta = 0.3575, nrounds = 150, eval_metric = "auc")
